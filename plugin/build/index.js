...
function createFunctionIfNotExists(lines, fc, content, ret) {
  ...
  if (index != -1) {
    lines.splice(index + 2, 0, ...[
      '//Start code generated by react-native-push-notification-ios',
     ...content,
      '//End code generated by react-native-push-notification-ios'
    ]);
  } else {
    index = lines.findIndex(line => line.indexOf('@end') != -1);

    lines.splice(index, 0, ...[
      '//Start function generated by react-native-push-notification-ios', 
      fc, 
      '{', 
      ...content, 
      ret, 
      '}', 
      '//End function generated by react-native-push-notification-ios',
      ''
